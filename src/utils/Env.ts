...
export const dotenv = (): DotEnv => {
    const { TWITCH_TOKEN, TWITCH_REFRESHTOKEN, TWITCH_CLIENTID, TWITCH_CLIENTSECRET, DISCORD_TOKEN } = process.env;
    ...
    return { TWITCH_CLIENTID, TWITCH_CLIENTSECRET, TWITCH_REFRESHTOKEN, TWITCH_TOKEN, DISCORD_TOKEN };
};
